...
export default function DetailComponent_1(){
    return (
        <div>
            <Container className="d-flex mt-5">
            <div className="d-flex gap-5 justify-content-center">
                <img src="/image/Product 2.png" width={"32%"} alt=""></img>
                <div className="flex-column">
                <h1 className="fw-bold" style={{color:"#613D2B"}}>Ethiopia Beans</h1>
                <p className="card-text" style={{color:"#974A4A"}}>Stock : 99</p>
                ...
                <h2 className="d-flex fw-bold justify-content-end" style={{color:"#974A4A"}} >Rp.109.000</h2>
